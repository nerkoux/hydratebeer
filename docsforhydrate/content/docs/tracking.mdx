...
description: Learn what performance metrics 🍺 HydrateBeer collects
---

# What Gets Tracked

🍺 HydrateBeer automatically collects various performance metrics to help you understand your application's behavior.
...
✅ SDK errors never throw or crash  
✅ All operations wrapped in try/catch  
✅ Failed sends retry on next batch
...
🍺 HydrateBeer: Collected metric { eventType: 'hydration', duration: 342ms }
🍺 HydrateBeer: Flushing 10 events to Tinybird
🍺 HydrateBeer: Events sent successfully (200 OK)
```
